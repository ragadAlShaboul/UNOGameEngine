...
public class InitializeGameV2 implements InitializeGame {
    ...
    public LinkedList<Card> createCardDeck() {
        ...
        for(int i = 0 ; i < 2 ; i++){
            ...
            for (String color : colors) {
                ...
                cardDeck.add(new GoldenCard("Golden","Black"));
    ...
    public LinkedList<Player> initiatePlayers() {
        ...
        while(numOfPlayers<2 || numOfPlayers > 7){
            System.out.println("Number of Players has to be between (2-5)\nEnter the number of players: ");
